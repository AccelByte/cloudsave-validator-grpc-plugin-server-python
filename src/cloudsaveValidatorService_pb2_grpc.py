...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in cloudsaveValidatorService_pb2_grpc.py depends on'
...
def add_CloudsaveValidatorServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('accelbyte.cloudsave.validator.CloudsaveValidatorService', rpc_method_handlers)
